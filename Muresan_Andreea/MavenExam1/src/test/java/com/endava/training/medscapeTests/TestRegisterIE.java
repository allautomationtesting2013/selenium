 ...
 * @version 1.0
 */
public class TestRegisterIE extends IExplorerSettings {

	ResourceBundle bundle4 = ResourceBundle.getBundle("values");

	String FIRST_NAME = bundle4.getString("firstName");
	String LAST_NAME = bundle4.getString("lastName");
	String ZIP_CODE = bundle4.getString("zipCode");
	String PASSWORD = bundle4.getString("password");
	String PET_NAME = bundle4.getString("petName");
	String MED_URL = bundle4.getString("medUrlRegister");

	/**
	 * This Test method verifies the successful registration of a new user on
	 * medscape.com website using Internet Explorer browser.
	 * 
	 * @throws InterruptedException
	 */
	@Test
	public void testRegisterFirefox() throws InterruptedException {
		...
		WebElement form = driver.findElement(By.xpath("//*[@id='country']"));

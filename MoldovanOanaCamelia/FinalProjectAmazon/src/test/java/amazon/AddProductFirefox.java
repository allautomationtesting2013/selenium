...
/**
 * This class logs in to amazon.com from the MozillaFirefox browser, using a random email and adds a product to a shopping cart
 */
...
public class AddProductFirefox extends FirefoxSettings {

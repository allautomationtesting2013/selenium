...
/**
 * This class is used for perform test on VMwareRegistration using Internet
 * Explorer driver. And validate the fields.
 * 
 * @author Alexandra Perja
 * 
 */
public class TestRegisterVMwareIE extends BrowserSettingsIE {

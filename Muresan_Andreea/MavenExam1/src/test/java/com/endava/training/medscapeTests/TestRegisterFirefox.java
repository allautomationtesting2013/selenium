 ...
 * @version 1.0
 */
public class TestRegisterFirefox extends FirefoxSettings {

	ResourceBundle bundle3 = ResourceBundle.getBundle("values");

	String FIRST_NAME = bundle3.getString("firstName");
	String LAST_NAME = bundle3.getString("lastName");
	String ZIP_CODE = bundle3.getString("zipCode");
	String PASSWORD = bundle3.getString("password");
	String PET_NAME = bundle3.getString("petName");
	String MED_URL = bundle3.getString("medUrlRegister");

	/**
	 * This Test method verifies the successful registration of a new user on
	 * medscape.com website using Mozilla Firefox browser.
	 * 

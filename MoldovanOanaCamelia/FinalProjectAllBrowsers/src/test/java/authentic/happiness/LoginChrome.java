...
public class LoginChrome extends ChromeSettings {
	...
	/**
	 * This is a test method that verifies the login option for an existing account on mojang.com, using the Chrome browser 
	 */
	@Test

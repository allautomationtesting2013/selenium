...
/**
 * This class implements the Login method that uses InternetExplorer Browser
 * 
 * @author fionce
 * 
 */
public class TestLoginNegativeIE extends IEBrowserSettings {
	 ...
	 * Chrome Browser, using an invalid password
	 * 

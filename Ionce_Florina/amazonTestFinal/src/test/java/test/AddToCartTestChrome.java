...
/**
 * This class implements the Buy method that uses Chrome Browser
 * 
 * @author fionce
 * 
 */
public class AddToCartTestChrome extends ChromeBrowserSettings {
	 ...
	 * account on Amazon.com and adds products to shopping cart, using Chrome
	 * Browser
	 * 

...
/**
 * This class implements the testLogin method that uses MozillaFirefox browser
 */
...
public class LoginFirefox extends FirefoxSettings {
	...
	/**
	 * This is a test method that verifies the login option for an existing account on mojang.com, using the MozillaFirefox browser 
	 */
	@Test

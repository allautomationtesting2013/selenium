...
/**
 * This class implements the test21Register method that uses Firefox Browser
 * 
 * @author fionce
 * @version 1.0
 */

public class TestRegisterFirefox extends BrowserSettings {
	 ...
	 * Mojing.com, using Firefox Browser account. It completes all necessary

...
/**
 * This class implements the testRegister method that uses InternetExplorer browser
 */
...
public class RegisterIExplorer extends IExplorerSettings {
	...
	/**
	 * This is a test method that verifies the register option for an account on mojang.com, using the InternetExplorer browser 

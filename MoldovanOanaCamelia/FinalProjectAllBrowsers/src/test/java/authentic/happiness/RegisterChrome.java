...
/**
 * This class implements the testRegister method that uses Chrome browser
 */
...
public class RegisterChrome extends ChromeSettings {
	...
	/**
	 * This is a test method that verifies the register option for an account on mojang.com, using the Chrome browser 
